...
- [~] `related-party-transactions-governance-singapore-insurers` — skipped: substantively already covered as a section of the just-published `mas-corporate-governance-guidelines-insurers-singapore` post (2026-09-19), which has "related party transaction oversight insurer board Singapore" as a secondary keyword — do not write a standalone post on this without a genuinely new angle
- [~] `global-listing-board-resident-director-singapore` — skipped: cannibalises `sgx-nasdaq-global-listing-board-singapore` (Round 1, keywords "Global Listing Board Singapore" / "SGX Nasdaq dual listing") — revisit only with a distinct angle (e.g. a specific issuer's resident-director appointment once one exists)
- [x] `issb-scope3-sti-companies-singapore` — published 2026-09-20 as `issb-scope3-sti-companies-singapore-fy2026`, "Scope 3 Emissions Reporting Is Mandatory for STI Companies From FY2026 — What Boards Need Before Year-End" (2026-09-20 SERP output: 0/18 ranked, no declined flags, top suggested target `actuarial board advisor Singapore` already cannibalises an existing post, so fell back to backlog order; this item lined up naturally with that day's tier-2 rotation keyword "scope 3 emissions Singapore boards")
- [~] `sustainability-assurance-scope-1-2-singapore-fy2027` — skipped: the FY2027 date in this entry was stale/wrong (2026-09-22 research: ACRA/SGX RegCo confirm mandatory external limited assurance over Scope 1/2 is FY2029 for listed companies, FY2032 for large non-listed companies — not FY2027), and the FY2029 listed-company assurance deadline is already covered as a secondary point in the published `issb-scope3-sti-companies-singapore-fy2026` post (id 46) — do not write a standalone post on this without a genuinely new angle beyond what's already published
- [x] `issb-reporting-large-non-listed-companies-singapore` — published 2026-09-22 as same slug, "ISSB-Aligned Reporting Reaches Singapore's Large Private Companies From FY2030 — Most Don't Have the Board For It" (corrected the backlog's stale FY2027 date to the verified FY2030 date per ACRA's timeline page; angle is the board-governance gap in large private companies — no mandated independent directors or risk committee — rather than the data-collection angle already used for the STI Scope 3 post)
