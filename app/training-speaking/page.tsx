    ...
    <div style={{ backgroundColor: "var(--warm-ivory)", paddingTop: "96px" }}>
      <section style={{ backgroundColor: "var(--midnight-navy)", padding: "5rem 2rem 4rem", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 800, letterSpacing: "-0.03em", color: "var(--warm-ivory)", lineHeight: 1.12, maxWidth: "680px", marginBottom: "1.5rem" }}>
            Complex subjects. Clear conversations. Practical conclusions.
          </h1>
          <p style={{ fontSize: "1.05rem", color: "rgba(245,243,236,0.65)", lineHeight: 1.75, maxWidth: "560px" }}>
      ...
      <section style={{ padding: "5rem 2rem", backgroundColor: "var(--warm-ivory)" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5px" }} className="pathway-grid">
          <div style={{ backgroundColor: "var(--white)", border: "1px solid rgba(7,26,43,0.08)", padding: "3rem" }}>
            <div style={{ width: "40px", height: "2px", backgroundColor: "var(--strategic-teal)", marginBottom: "1.75rem" }} />
            <h2 style={{ fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontSize: "1.3rem", fontWeight: 700, letterSpacing: "-0.02em", color: "var(--midnight-navy)", marginBottom: "0.75rem" }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, marginBottom: "2rem" }}>
              {trainingOfferings.map((item) => (
                <li key={item} style={{ fontSize: "0.875rem", color: "var(--midnight-navy)", padding: "0.65rem 0", borderBottom: "1px solid rgba(7,26,43,0.05)", display: "flex", alignItems: "center", gap: "0.6rem" }}>
          ...
          <div style={{ backgroundColor: "var(--midnight-navy)", border: "1px solid rgba(21,154,146,0.15)", padding: "3rem" }}>
            <div style={{ width: "40px", height: "2px", backgroundColor: "var(--gold)", marginBottom: "1.75rem" }} />
            <h2 style={{ fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontSize: "1.3rem", fontWeight: 700, letterSpacing: "-0.02em", color: "var(--warm-ivory)", marginBottom: "0.75rem" }}>
              Speaking & Industry Engagement
            </h2>
            <p style={{ fontSize: "0.9rem", color: "rgba(245,243,236,0.6)", lineHeight: 1.75, marginBottom: "2rem" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", marginBottom: "2rem" }}>
              {speakingFormats.map((fmt) => (
                <div key={fmt.label} style={{ display: "flex", alignItems: "center", gap: "0.4rem", backgroundColor: "rgba(21,154,146,0.1)", border: "1px solid rgba(21,154,146,0.2)", padding: "0.4rem 0.75rem", borderRadius: "1px", color: "rgba(245,243,236,0.7)" }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, marginBottom: "2rem" }}>
              {speakingOfferings.map((item) => (
                <li key={item} style={{ fontSize: "0.875rem", color: "rgba(245,243,236,0.65)", padding: "0.5rem 0", borderBottom: "1px solid rgba(21,154,146,0.08)", display: "flex", alignItems: "center", gap: "0.6rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
              ...
              <button disabled style={{ display: "inline-flex", alignItems: "center", gap: "0.4rem", padding: "0.75rem 1.25rem", backgroundColor: "transparent", color: "rgba(245,243,236,0.4)", fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontWeight: 500, fontSize: "0.78rem", border: "1px solid rgba(245,243,236,0.15)", borderRadius: "1px", cursor: "not-allowed" }}>
      ...
      <section style={{ padding: "5rem 2rem", backgroundColor: "var(--soft-mist)" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <h2 style={{ fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontSize: "clamp(1.4rem, 2.5vw, 1.9rem)", fontWeight: 700, letterSpacing: "-0.02em", color: "var(--midnight-navy)", marginBottom: "3rem" }}>
            Speaking themes
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "1.5px" }}>
            {speakingThemes.map((theme, i) => (
              <div key={theme} style={{ backgroundColor: "var(--white)", border: "1px solid rgba(7,26,43,0.07)", padding: "1.75rem", display: "flex", alignItems: "flex-start", gap: "1.25rem" }}>
                ...
                <p style={{ fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontSize: "0.9rem", fontWeight: 600, color: "var(--midnight-navy)", lineHeight: 1.45 }}>{theme}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "5rem 2rem", backgroundColor: "var(--warm-ivory)" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "1.5px" }}>
            {programmes.map((prog) => (
              <div key={prog.id} style={{ backgroundColor: "var(--white)", border: "1px solid rgba(7,26,43,0.08)", padding: "2rem" }}>
                ...
                <h3 style={{ fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontSize: "0.975rem", fontWeight: 700, color: "var(--midnight-navy)", marginBottom: "0.5rem", lineHeight: 1.3 }}>{prog.title}</h3>
                ...
                <p style={{ fontSize: "0.75rem", color: "rgba(32,42,51,0.5)", marginBottom: "0.3rem" }}>Mode: {prog.deliveryMode}</p>
                {prog.audience && <p style={{ fontSize: "0.75rem", color: "rgba(32,42,51,0.5)", marginBottom: "1.25rem" }}>Audience: {prog.audience}</p>}
