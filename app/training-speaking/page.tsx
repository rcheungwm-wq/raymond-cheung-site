    ...
    <div style={{ backgroundColor: "var(--warm-ivory)", paddingTop: "96px" }}>
      ...
      <section style={{ padding: "5rem 2rem", backgroundColor: "var(--warm-ivory)" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5px" }} className="pathway-grid">
          <div style={{ backgroundColor: "var(--panel)", border: "1px solid rgba(26,23,18,0.08)", padding: "3rem" }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, marginBottom: "2rem" }}>
              {trainingOfferings.map((item) => (
                <li key={item} style={{ fontSize: "0.875rem", color: "var(--ink)", padding: "0.65rem 0", borderBottom: "1px solid rgba(26,23,18,0.05)", display: "flex", alignItems: "center", gap: "0.6rem" }}>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "1.5px" }}>
            {speakingThemes.map((theme, i) => (
              <div key={theme} style={{ backgroundColor: "var(--panel)", border: "1px solid rgba(26,23,18,0.07)", padding: "1.75rem", display: "flex", alignItems: "flex-start", gap: "1.25rem" }}>
      ...
      <section style={{ padding: "5rem 2rem", backgroundColor: "var(--warm-ivory)" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "1.5px" }}>
            {programmes.map((prog) => (
              <div key={prog.id} style={{ backgroundColor: "var(--panel)", border: "1px solid rgba(26,23,18,0.08)", padding: "2rem" }}>
                ...
                <p style={{ fontSize: "0.75rem", color: "rgba(26,23,18,0.5)", marginBottom: "0.3rem" }}>Mode: {prog.deliveryMode}</p>
                {prog.audience && <p style={{ fontSize: "0.75rem", color: "rgba(26,23,18,0.5)", marginBottom: "1.25rem" }}>Audience: {prog.audience}</p>}
