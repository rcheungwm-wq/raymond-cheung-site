...
const domains = [
  {
    ...
    tag: "ERM",
    summary: "Risk frameworks that actually guide decisions — connecting risk appetite, governance, strategy and board reporting into a coherent system that works under pressure.",
  ...
  },
  {
    ...
    tag: "Insurance",
    summary: "Capital is not just a regulatory number. It shapes strategic choices, product viability and reinsurance structure. Raymond connects technical capital decisions to commercial strategy.",
  ...
  },
  {
    ...
    tag: "ESG",
    summary: "Moving organisations from broad commitments to measurable governance, underwriting, investment and disclosure action — before regulators require it.",
  ...
  },
  {
    ...
    tag: "Governance",
    summary: "Helping boards ask better questions and build real oversight capability — not receive polished presentations. Grounded in Raymond's own experience as a listed-company independent director.",
  ...
  },
  {
    ...
    tag: "InsurTech",
    summary: "Insurance and technology expertise combined — from building digital insurance at platform scale across eight ASEAN markets to governing AI responsibly in underwriting and claims.",
  ...
  },
  {
    ...
    tag: "Education",
    summary: "Technically rigorous, practically grounded programmes for boards, executives and professionals — designed by a practitioner who has occupied the roles participants aspire to lead.",
