        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "1.25rem" }}>
          {featured.map((insight) => (
            <article key={insight.id} className="card-hover" style={{
              ...
              <h3 style={{ fontFamily: "var(--font-plus-jakarta), system-ui, sans-serif", fontSize: "1rem", fontWeight: 700, letterSpacing: "-0.01em", color: "var(--ink)", marginBottom: "0.85rem", lineHeight: 1.35, flex: 1 }}>
                {insight.title}
              </h3>
